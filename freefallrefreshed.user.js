...
// @include      http://freefall.purrsia.com/zu.htm
// @grant        GM_addStyle
...
(function() {
    ...
    //basic stuff
    GM_addStyle("html{font-family: arial, sans-serrif; max-width: 100vw; overflow-x: hidden;}");
    GM_addStyle("body, body > p:nth-child(19){text-align: center; background: #555555; color: white;}");
    //top navbar
    GM_addStyle("table tr {background: transparent; font-size: 0;} table b {font-size: initial;} table b a {display: inline-block; padding: 0.5em; margin: 0.25em; border-radius: 1em; color: black; background: white; text-decoration: none; border: 3px solid white;} table b a:hover{transition: all 0.2s ease; border: 3px solid #ff9d3f;}");
    //clickable images
    ...
    //Arvhive page tweaks
    GM_addStyle("body > table:nth-child(1) > tbody:nth-child(1) > tr:nth-child(1) > td:nth-child(1) > font:nth-child(9), body > table:nth-child(1) > tbody:nth-child(1) > tr:nth-child(1) > td:nth-child(1) > font:nth-child(10) {display: block; padding-top: 5em;} body > p:nth-child(12) > table:nth-child(1), body > p:nth-child(15) > table:nth-child(1), body > p:nth-child(13) > table:nth-child(1),body > p:nth-child(14) > table:nth-child(1) {padding-left: 20vw;}");
    //Awards page (currently broken)
    GM_addStyle("body > p:nth-child(4) > a:nth-child(1) > img:nth-child(1) {display: inline-block !important;}");
    //Making the comic strips a bit responsive...
    GM_addStyle("body > a:nth-child(5) > img:nth-child(1), body > a:nth-child(4) > img:nth-child(1), body > a:nth-child(7) > img:nth-child(1), body > a:nth-child(10) > img:nth-child(1) {width: auto; max-width: 100%; height: auto;}");
})();
